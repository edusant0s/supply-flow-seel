...
const moduleViewers: Record<ModuleKey, UserRole[]> = {
  ...
  cadastro_materiais: ["super_admin", "admin_suprimentos", "admin_orcamentos", "admin_contratos", "viewer_global", "viewer"],
...
export const permissionModules: Array<{ key: ModuleKey; label: string; description: string }> = [
  ...
  { key: "cadastro_materiais", label: "Cadastro materiais", description: "Solicitacoes e cadastro de itens/materiais." },
