import{A as e,c as t,k as n,n as r,r as i,s as a}from"./index-CYps1W0I.js";import{a as o,c as s,i as c,l,n as u,r as d,t as f}from"./embeddedSync-BtO9ITSr.js";var p=e(n(),1),m=t(),h=`
  html, body {
    min-height: 100%;
...
`;function g(e,t,n){let r=`<base href="${t}"><style>${h}</style>${_(n)}`;return/<head[^>]*>/i.test(e)?e.replace(/<head([^>]*)>/i,`<head$1>${r}`):`<!doctype html><html lang="pt-BR"><head>${r}</head><body>${e}</body></html>`}function _(e){return`<script>
...
<\/script>`}function v({title:e,moduleKey:t,loadHtml:n}){let[h,_]=(0,p.useState)(null),[v,y]=(0,p.useState)(null),[b,x]=(0,p.useState)(null),{session:S,profile:C,obras:w}=a();(0,p.useEffect)(()=>{let e=!0;return _(null),y(null),x(null),Promise.all([n(),l(t)]).then(([t,n])=>{e&&(_(t),y(n))}).catch(()=>{e&&x(`Nao foi possivel carregar este modulo.`)}),()=>{e=!1}},[n,t]);let T=(0,p.useMemo)(()=>{if(!(!h||!v))return g(h,new URL(`/supply-flow-seel/`,window.location.origin).toString(),{module:t,role:C?.role||`viewer`,canManage:i(C?.role,t),user:{nome:C?.nome||``,email:C?.email||``},obras:w.map(e=>({id:e.id,nome:e.nome,codigo:e.codigo,centro_custo:e.centro_custo})),sharedStorage:v,integrations:{googleMapsApiKey:``},sync:{supabaseUrl:`https://cujospvzkulzdgzxyfyp.supabase.co`,supabaseAnonKey:`eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImN1am9zcHZ6a3VsemRnenh5ZnlwIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODA2MjUyODMsImV4cCI6MjA5NjIwMTI4M30.uKytO-xbHVDWbHOaGmELVjPiEQIRi5q6q8CdHU7k4nU`,accessToken:S?.access_token||``,contractFormStorageKey:u,contractRequestsStorageKey:d,freightStorageKey:o,stockStateKey:c,evaluationDbKey:f,sharedStateKeys:s(t).filter(e=>e!==`gestao_fretes_solicitacoes_v1`&&e!==`seel_requests_google_forms_exato_v1`)}})},[h,t,w,C,S,v]);return b?(0,m.jsxs)(`section`,{className:`state-panel`,children:[(0,m.jsx)(`h2`,{children:b}),(0,m.jsx)(`p`,{children:`Atualize a pagina e tente novamente.`})]}):T?(0,m.jsx)(`div`,{className:`embedded-tool-page`,children:(0,m.jsx)(`iframe`,{className:`embedded-tool-frame`,title:e,srcDoc:T,sandbox:`allow-same-origin allow-scripts allow-forms allow-modals allow-downloads allow-popups allow-popups-to-escape-sandbox`})}):(0,m.jsx)(r,{label:`Carregando ${e}...`})}export{v as t};